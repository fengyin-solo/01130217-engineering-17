...
const { render: renderMonitorChart } = useEChart(monitorChart, { name: 'hse.monitor' })
const { render: renderRiskChart } = useEChart(riskChart, { name: 'hse.risk' })
